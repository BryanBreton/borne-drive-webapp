    ...
    <v-container>
      ...
      <v-row>
        <v-col class=".col-md-6 justify-center">          
          <v-row>
            <v-col>
              <v-btn @click="clique('1')">1</v-btn>
            </v-col>
            <v-col>
              <v-btn @click="clique('2')">2</v-btn>
            </v-col>
            <v-col>
              <v-btn @click="clique('3')">3</v-btn>
            </v-col>
          </v-row>
          <v-row>
            <v-col>
              <v-btn @click="clique('4')">4</v-btn>
            </v-col>
            <v-col>
              <v-btn @click="clique('5')">5</v-btn>
            </v-col>
            <v-col>
              <v-btn @click="clique('6')">6</v-btn>
            </v-col>
          </v-row>
          <v-row>
            <v-col>
              <v-btn @click="clique('7')">7</v-btn>
            </v-col>
            <v-col>
              <v-btn @click="clique('8')">8</v-btn>
            </v-col>
            <v-col>
              <v-btn @click="clique('9')">9</v-btn>
            </v-col>
          </v-row>
          <v-row>
            <v-col>
              <v-btn @click="clique('0')">0</v-btn>
            </v-col>
            <v-col>
              <v-btn class="orange" @click="effacer()">R</v-btn>
            </v-col>
            <v-col>
              <v-btn class="green" @click="valider()">V</v-btn>
            </v-col>
          </v-row>
        </v-col>
